...
export function Sidebar() {
    ...
    return (<div className="w-64 h-screen bg-zinc-950 border-r border-zinc-800 flex flex-col">
      {/* Header */}
      ...
      <div className="border-t border-zinc-800 p-4 space-y-2">
        {user && (<div className="px-3 py-2 text-sm">
        ...
        <button onClick={handleLogout} className="w-full flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-zinc-900 transition-colors text-sm text-red-400">
